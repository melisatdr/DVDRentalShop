using DVDRentalShop.Config;
using DVDRentalShop.Models;
using Npgsql;
using System;
	...
	class Menu
	{
		...
		private void Option9()
		{
			...
			while (true)
			{
				...
				Console.WriteLine("Write the information from what you want to see stats");
		...
		public void Print(string msg = "")
		{
			...
			Console.WriteLine("Welcome to DVD Rental Store Menu:\n");
			Console.WriteLine("1. Currently we have the following offer to you.");
			Console.WriteLine("2. Viewing client rentals information");
			Console.WriteLine("3. You are Creating  new rentals on the DVD rental store");
			Console.WriteLine("4. Registering the returns");
			Console.WriteLine("5. See all clients on the DVD rental store  ");
			Console.WriteLine("6. Creating new user on the DVD rental store");
			Console.WriteLine("7. Creating new movie on the DVD rental store");
			Console.WriteLine("8. Show overdue rentals on the DVD rental store");
			Console.WriteLine("9. Show the statistics of the DVD rental store");
